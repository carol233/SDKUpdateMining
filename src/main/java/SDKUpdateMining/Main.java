...
public class Main {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        String outputSaveAPI = args[3];
        String CDAPath = args[4];
        ...
        SDKUpdateTransformer sdkUpdateTransformer = new SDKUpdateTransformer(appPath, outputPath, outputSaveAPI, CDAPath);
    }
}


class SDKUpdateTransformer extends BodyTransformer
{
...
//                                    getField("<android.os.Build$VERSION: int SDK_INT>").makeRef());
            ...
            if (stmt instanceof IfStmt && null != sdkValue) {
                ...
                if (!unitIter.hasNext() && !case_.equals("both")) {
