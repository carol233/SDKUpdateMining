...
public class BranchUnit {
    ...
    public List<UnitInfo> ifBranchUnits = new ArrayList<>();
    ...
    public List<String> ifBranchUnitList = new ArrayList<>();
    ...
    public List<UnitInfo> elseBranchUnits = new ArrayList<>();
    ...
    public List<String> elseBranchUnitList = new ArrayList<>();
