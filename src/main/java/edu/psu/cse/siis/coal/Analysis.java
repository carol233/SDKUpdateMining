...
public abstract class Analysis<A extends CommandLineArguments> {
   ...
   *
   * @param directory A {@link File File} object for the directory under which classes
   ...
   *
   * @param file A {@link File File} object for the jar in which classes should be searched
   *          for.
